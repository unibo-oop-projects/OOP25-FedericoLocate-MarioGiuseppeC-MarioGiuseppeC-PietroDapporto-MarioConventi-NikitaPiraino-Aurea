...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{problema_modellazione_carte.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{problema_scalabilità_carte.png}}
...
\begin{itemize}
    ...
    \item nelle condizioni non richiamare delle funzioni ma mettere il loro contenuto direttamente nel metodo \texttt{getGameState()}: supporta meno per necessità future i principi Don't Repeat Yourself e Single Responsability.
\end{itemize}
...
\begin{itemize}
    ...
    YAML coincidano rispettivamente con con ciò che è contenuto dentro l'implementazione delle carte create e dei followup.
...
% =============================================================================
Questa guida mostra i passaggi principali per iniziare e svolgere una partita ad \textit{Aurea Mediocritas}.

\section{Avvio della partita}

All'apertura del gioco viene mostrata la schermata iniziale. Prima di iniziare, 
il giocatore deve inserire il proprio nome e il nome della facoltà o università. 
Nella stessa schermata è possibile scegliere la difficoltà della partita.

In basso a destra è presente il pulsante delle informazioni, che permette di 
leggere una breve spiegazione delle regole del gioco. Dopo aver completato i campi richiesti, la partita può essere avviata premendo il pulsante \textit{Begin your Reign}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{schermata_iniziale.png}
    \caption{Schermata iniziale: inserimento dei dati, scelta della difficoltà e avvio della partita.}
\end{figure}

\section{Schermata di gioco}

Una volta iniziata la partita, al centro dello schermo viene mostrata una carta. Ogni carta rappresenta una situazione a cui il giocatore deve rispondere prendendo una decisione.

Nella parte superiore della schermata sono visibili i parametri principali dell'università, che indicano lo stato della partita. Il giocatore deve cercare di mantenerli in equilibrio fino alla fine del gioco.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{schermata_gioco.png}
    \caption{Schermata principale di gioco, con carta e parametri dell'università.}
\end{figure}

\section{Scelta delle decisioni}

Per prendere una decisione, il giocatore deve tenere premuta la carta e trascinarla verso destra o verso sinistra. Lo spostamento della carta mostra le due possibili risposte.

Durante il trascinamento compaiono alcuni indicatori sopra i parametri: essi segnalano quali aspetti della partita saranno modificati dalla scelta. Quando il giocatore rilascia la carta, la decisione viene confermata e il gioco passa alla carta successiva.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{swipe_destra.png}
    \caption{Swipe a destra per l'approvazione della proposta.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{swipe_sinistra.png}
    \caption{Swipe a sinistra per il rifiuto della proposta.}
\end{figure}

\section{Fine della partita}

La partita termina quando il giocatore completa il periodo previsto dal gioco 
oppure quando uno dei parametri raggiunge un valore critico (il minimo o il massimo). 
In questo caso viene mostrata una schermata finale con l'esito della partita.
